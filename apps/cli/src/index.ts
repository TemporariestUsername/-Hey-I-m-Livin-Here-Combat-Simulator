...
import { assertRunLog, assertScenario, parseJsonDocument, validateScenario } from "../../../packages/schema/src/index.ts";
...
async function json(path: string): Promise<unknown> {
  return parseJsonDocument(await readFile(resolve(path), "utf8"));
}
